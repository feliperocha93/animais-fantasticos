...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return ScrollAnimacao; });\n/* harmony import */ var _debounce__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./debounce */ \"./js/modules/debounce.js\");\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) { descriptor.writable = true; } Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) { _defineProperties(Constructor.prototype, protoProps); } if (staticProps) { _defineProperties(Constructor, staticProps); } return Constructor; }\n\n\n\nvar ScrollAnimacao =\n/*#__PURE__*/\nfunction () {\n  function ScrollAnimacao(sections, events, activeClass) {\n    _classCallCheck(this, ScrollAnimacao);\n\n    this.sections = document.querySelectorAll(sections);\n    this.events = events;\n    this.activeClass = activeClass;\n    this.windowMetade = window.innerHeight * 0.6;\n    this.animaScroll = Object(_debounce__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(this.animaScroll.bind(this), 50);\n  }\n\n  _createClass(ScrollAnimacao, [{\n    key: \"animaScroll\",\n    value: function animaScroll() {\n      var _this = this;\n\n      var _a = this.sections;\n\n      var _f = function _f(section) {\n        var sectionTop = section.getBoundingClientRect().top;\n        var isSectionVisible = sectionTop - _this.windowMetade < 0;\n\n        if (isSectionVisible) {\n          section.classList.add(_this.activeClass);\n        } else if (section.classList.contains(_this.activeClass)) {\n          section.classList.remove(_this.activeClass);\n        }\n      };\n\n      for (var _i = 0; _i < _a.length; _i++) {\n        _f(_a[_i], _i, _a);\n      }\n\n      undefined;\n    }\n  }, {\n    key: \"addScrollListener\",\n    value: function addScrollListener() {\n      window.addEventListener(this.events, this.animaScroll);\n    }\n  }, {\n    key: \"init\",\n    value: function init() {\n      if (this.sections.length) {\n        this.addScrollListener();\n      }\n    }\n  }]);\n\n  return ScrollAnimacao;\n}();\n\n\n\n//# sourceURL=webpack:///./js/modules/scroll-animacao.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _modules_accordion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/accordion */ \"./js/modules/accordion.js\");\n/* harmony import */ var _modules_dropdown_menu__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./modules/dropdown-menu */ \"./js/modules/dropdown-menu.js\");\n/* harmony import */ var _modules_funcionamento__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/funcionamento */ \"./js/modules/funcionamento.js\");\n/* harmony import */ var _modules_menu_mobile__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/menu-mobile */ \"./js/modules/menu-mobile.js\");\n/* harmony import */ var _modules_modal__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/modal */ \"./js/modules/modal.js\");\n/* harmony import */ var _modules_scroll_animacao__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/scroll-animacao */ \"./js/modules/scroll-animacao.js\");\n/* harmony import */ var _modules_scroll_suave__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/scroll-suave */ \"./js/modules/scroll-suave.js\");\n/* harmony import */ var _modules_tabnav__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/tabnav */ \"./js/modules/tabnav.js\");\n/* harmony import */ var _modules_tooltip_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/tooltip.js */ \"./js/modules/tooltip.js\");\n/* harmony import */ var _modules_fetch_animais_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/fetch-animais.js */ \"./js/modules/fetch-animais.js\");\n/* harmony import */ var _modules_fetch_bitcoin_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/fetch-bitcoin.js */ \"./js/modules/fetch-bitcoin.js\");\n\n\n\n\n\n\n\n\n\n\n\nvar clickEvents = ['click', 'touchstart'];\nvar accordion = new _modules_accordion__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('[data-anime=\"accordion\"] dt', 'ativo', clickEvents);\naccordion.init();\nvar dropdownMenu = new _modules_dropdown_menu__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('[data-dropdown]', clickEvents);\ndropdownMenu.init();\nvar funcionamento = new _modules_funcionamento__WEBPACK_IMPORTED_MODULE_2__[\"default\"]('[data-semana]');\nfuncionamento.init();\nvar menuMobile = new _modules_menu_mobile__WEBPACK_IMPORTED_MODULE_3__[\"default\"]('[data-menu=\"button\"]', '[data-menu=\"list\"]', clickEvents, 'active');\nmenuMobile.init();\nvar modal = new _modules_modal__WEBPACK_IMPORTED_MODULE_4__[\"default\"]('[data-modal=\"abrir\"]', '[data-modal=\"fechar\"]', '[data-modal=\"container\"]', clickEvents, 'ativo');\nmodal.init();\nvar scrollAnimacao = new _modules_scroll_animacao__WEBPACK_IMPORTED_MODULE_5__[\"default\"]('[data-anime=\"scroll\"]', 'scroll', 'ativo');\nscrollAnimacao.init();\nvar scrollSuave = new _modules_scroll_suave__WEBPACK_IMPORTED_MODULE_6__[\"default\"]('[data-menu=\"suave\"] a[href^=\"#\"]', clickEvents);\nscrollSuave.init();\nvar tabnav = new _modules_tabnav__WEBPACK_IMPORTED_MODULE_7__[\"default\"]('[data-tab=\"menu\"] li', '[data-tab=\"content\"] section', clickEvents, 'ativo');\ntabnav.init();\nObject(_modules_tooltip_js__WEBPACK_IMPORTED_MODULE_8__[\"default\"])();\nObject(_modules_fetch_animais_js__WEBPACK_IMPORTED_MODULE_9__[\"default\"])();\nObject(_modules_fetch_bitcoin_js__WEBPACK_IMPORTED_MODULE_10__[\"default\"])();\n\n//# sourceURL=webpack:///./js/script.js?");
